...
$(".contact").click(function (){
    ...
    $(".contactInfoRef").removeClass("activeflex");
    ...
    $(".contactInfoRef[data-ref=" + clickedcontact +"]").addClass("activeflex");
})